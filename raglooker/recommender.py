...
class GameSearchEngine:
    ...
    def rewrite_query(self, query: str) -> dict[str, Any]:
        ...
        """
        prompt = (
            f"You are a search query optimization expert for a Steam game recommendation engine.\n"
            ...
            f"2. If the query is completely unrelated to video games (e.g., cooking recipes, medical advice, general chat, homework), output ONLY the word 'NOT_RELEVANT'.\n"
