...
To ensure that the project can be evaluated without friction, the system has been designed for straightforward setup and execution. The only requirement is a machine running Python 3.13.4 (or 3.13+). As mentioned in the introduction of this report, the complete source code for this system is provided as a supplementary file in the submission and is also publicly available on GitHub for version-controlled auditing.
